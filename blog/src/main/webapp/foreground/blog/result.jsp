...
<div class="data_list">
		...
		搜索&nbsp;<font color="red">${input }</font>&nbsp;的结果 &nbsp;(总共搜索到&nbsp;${resultTotal }&nbsp;条记录) </div>
		  		...
		  		<c:otherwise>
		  			<c:forEach var="blog" items="${blogList}">
		  				<li style="margin-bottom: 20px">
							...
							<span class="link"><a href="${pageContext.request.contextPath}/blog/articles/${blog.blogId }.html">http://blog.LinFengBlog.com/blog/articles/${blog.blogId }.html</a>&nbsp;&nbsp;&nbsp;&nbsp;发布日期：${blog.releaseDateStr }</span>
						  </li>
		  			</c:forEach>
		  		</c:otherwise>
		  	</c:choose>
