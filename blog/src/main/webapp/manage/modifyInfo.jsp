...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
	<form id="form1" action="${pageContext.request.contextPath}/manage/blogger/save.do" method="post" enctype="multipart/form-data">
		<table cellspacing="20px">
			<tr>
				<td width="80px">用户名：</td>
				<td>
					<input type="hidden" id="id" name="id" value="${currentUser.id }"/>
					<input type="text" id="name" name="name" style="width: 200px" value="${currentUser.name }" readonly="readonly" />
				</td>
			</tr>
			<tr>
				<td>昵称：</td>
...
<script type="text/javascript">
    ...
    ue.addListener("ready",function(){
    	// 通过ajax请求数据
    	UE.ajax.request("${pageContext.request.contextPath}/manage/blogger/find.do",
    			{
    				method:"post",
    				async:false,
    				data:{},
